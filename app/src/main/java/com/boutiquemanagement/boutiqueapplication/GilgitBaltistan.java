...
public class GilgitBaltistan extends AppCompatActivity {
    GridView gridView;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        Cursor cursor1 = db.getData ("SELECT * FROM gilgit;");
        list.clear ();
        ...
        gridView.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener() {
            ...
            public boolean onItemLongClick(AdapterView<?> parent, View view, final int position, final long id) {
                ...
                AlertDialog.Builder dialog = new AlertDialog.Builder(GilgitBaltistan.this);
                ...
                dialog.setItems(items, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int item) {
                        if (item == 0) {
                            // update
                            Cursor c = db.getData("SELECT gid FROM gilgit;");
                            ArrayList<Integer> arrID = new ArrayList<Integer>();
                            while (c.moveToNext()){
                                arrID.add(c.getInt(0));
                            }
                            // show dialog update at here
                            showDialogopen (GilgitBaltistan.this, arrID.get(position));
                        }
    ...
    private void showDialogopen(Activity activity, final int position){
        ...
        dialog.show();
        Cursor cursor = db.getData ("Select * from gilgit where gid=" + position + "");
    ...
    public void cartc(View view)
    {
        ...
        Intent intent=new Intent (GilgitBaltistan.this,cart.class);
