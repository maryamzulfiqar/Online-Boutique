...
public class AdminDelGilgit extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        Cursor cursor = AdminAdd.db.getData("SELECT * FROM gilgit;");
        list.clear ();
        ...
        gridView.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener() {
            ...
            public boolean onItemLongClick(AdapterView<?> parent, View view, final int position, final long id) {
                ...
                AlertDialog.Builder dialog = new AlertDialog.Builder(AdminDelGilgit.this);
                ...
                dialog.setItems(items, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int item) {
                        if (item == 0) {
                            // update
                            Cursor c = AdminAdd.db.getData("SELECT gid FROM gilgit;");
                            ArrayList<Integer> arrID = new ArrayList<Integer>();
                            while (c.moveToNext()){ arrID.add(c.getInt(0));
                            }
                            showDialogUpdate(AdminDelGilgit.this, arrID.get(position));
                        }
                        else {
                            Cursor c = AdminAdd.db.getData("SELECT gid FROM gilgit");
                            ArrayList<Integer> arrID = new ArrayList<Integer>();
    ...
    private void showDialogDelete(final int idFood){
        final AlertDialog.Builder dialogDelete = new AlertDialog.Builder(AdminDelGilgit.this);
        ...
        dialogDelete.setPositiveButton("OK", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                try {
                    AdminAdd.db.deleteDataGilgit(idFood);
